<!--======================================================
    ...
    Note         : This page defines the Database Development Overview of Geek Infotech.  
=======================================================-->
        ...
        <div class="container">
            ...
            <div class="row candidate-profile">
    			...
    			<div class="profile-descr">
            		...
            		<h2 class="capitalize">💾 Backend Development Course Overview</h2>
            	...
            	<p>
                The <strong>Backend Development</strong> track at Geek Infotech is designed to build strong foundations in server-side programming, database management, and enterprise 							logic design. This course equips learners with the skills to architect robust, scalable, and secure backend systems that power modern applications.
            	</p>
            	<br>
            	...
            	<p style="font-weight:bold;">🔹 Key Focus Areas:</p>
            		...
            		<ul style="line-height:1.8; padding-left:15px;">
                		<li><strong>Oracle SQL & PL/SQL:</strong> Learn to write efficient queries, manage relational databases, and develop stored procedures, triggers, and packages 											for enterprise-grade applications.</li>
                		<li><strong>Database Design & Optimization:</strong> Understand normalization, indexing, performance tuning, and data integrity principles to build high-											performing systems.</li>
                		<li><strong>Server-Side Logic :</strong> Develop backend logic using SQL & PLSQL to support secure and scalable data operations.</li>
                		<li><strong>Authentication & Security:</strong> Implement user authentication, role-based access, and secure data handling practices.</li>
            		</ul>
            	<br>

            	<p style="font-weight:bold;">🧠 Learning Outcomes:</p>
           		 <ul style="line-height:1.8; padding-left:15px;">
                	<li>✅ Design and manage relational databases using Oracle tools</li>
                	<li>✅ Write optimized SQL queries and PL/SQL scripts</li>
                	<li>✅ Build backend services and APIs for web and mobile apps</li>
                	<li>✅ Apply best practices in data security and system architecture</li>
                	<li>✅ Prepare for roles like <strong>Database Developer</strong>, <strong>Backend Engineer</strong>, or <strong>Data Integration Specialist</strong></li>
            	 </ul>
            	<br>
				...
				<div class="col-md-4 col-md-offset-2 col-xs-12 mt80 text-center" style="margin-top:100px; padding:30px;">
    			  <div class="row">
        			<div class="col-xs-12 mb20">
            			<img src="images/courses/bdc_2.png" alt="Backend Development Course Overview" style="width:100%; higt:150%; border:2px solid #0056b3; border-radius:8px; margin-bottom:60px;">
        				</div>
        			<div class="col-xs-12 mb20">
            			<img src="images/courses/bdc_3.png" alt="Backend Development Career Paths" style="width:100%; higt:150%; border:2px solid #0056b3; border-radius:8px; margin-bottom:60px;">
        		   		</div>
        			<div class="col-xs-12 mb20">
            			<img src="images/courses/bdc_4.png" alt="Backend Development Career Paths" style="width:100%; higt:150%; border:2px solid #0056b3; border-radius:8px;">
        				</div>
    				</div>
				</div>
