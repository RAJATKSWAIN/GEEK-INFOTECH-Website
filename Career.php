<!--======================================================
    ...
    Note         : This page defines the Career Building in Geek Infotech.   
=======================================================-->
  		...
  		<div class="container">
    		<div class="row">
      		...
      		<div class="col-md-6 col-xs-12">
        		<h3 class="text-blue">Career</h3>
        		<p class="pt30">Kickstart your career in technology with Geek Infotech — where innovation meets mentorship, and potential turns into performance.</p>
        		<p class="pt30">We empower aspiring professionals with industry-aligned training, hands-on projects, and placement support to thrive in today’s competitive tech 										landscape.</p>
        		<p class="pt30">Geek Infotech maintains a transparent and ethical recruitment process. We never charge candidates for training or placement. If you receive any 										suspicious communication requesting payment, please report it to us immediately.</p>
        		<p class="pt30">Your career is more than a job — it’s a journey of continuous learning, growth, and impact. Let Geek Infotech be your launchpad.</p>
      		</div>
      		<!-- End of First Column -->

      		<!-- Start of Second Column with Career Images -->
      		<div class="col-md-6 col-xs-12">
        		<div class="row">
          			<div class="col-sm-6 mb-3">
            		<img src="images/career1.jpg" class="img-responsive img-thumbnail" alt="Career Image 1">
          			</div>
          		<div class="col-sm-6 mb-3">
            		<img src="images/career2.jpg" class="img-responsive img-thumbnail" alt="Career Image 2">
          		</div>
          		<div class="col-sm-6 mb-3">
            		<img src="images/career3.jpg" class="img-responsive img-thumbnail" alt="Career Image 3">
          		</div>
          		<div class="col-sm-6 mb-3">
            		<img src="images/career4.jpg" class="img-responsive img-thumbnail" alt="Career Image 4">
          		</div>
        	</div>
        </div>
